    ...
    <footer className="border-t border-border/60 bg-secondary/40">
      <div className="container py-10 grid gap-6 md:grid-cols-3">
        <div>
          ...
          <p className="mt-3 text-sm text-muted-foreground max-w-sm">A comprehensive learner driver ecosystem: K53 theory, AI vision, driving simulation, and life skills readiness.</p>
        </div>
