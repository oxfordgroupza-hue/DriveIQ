...
import { ShieldCheck, Eye, Gauge, GraduationCap, Smartphone, Activity, Users } from "lucide-react";
...
export default function Index() {
  const heroBg = "bg-[radial-gradient(40rem_20rem_at_10%_10%,hsl(var(--primary)/0.10),transparent),radial-gradient(50rem_25rem_at_90%_20%,hsl(var(--accent)/0.10),transparent)]";
    ...
    <div>
        ...
        <div className="container grid gap-10 py-20 md:py-28 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 text-xs text-muted-foreground sm:grid-cols-4">
              ...
              <div className="rounded-md border bg-background/50 p-3">Mobile-first</div>
            </div>
          </div>
          <div className="relative">
            <div className="aspect-[4/3] w-full overflow-hidden rounded-2xl border bg-gradient-to-br from-primary/15 via-background to-accent/15 shadow">
              <img src="/placeholder.svg" alt="DriveIQ preview" className="h-full w-full object-cover opacity-90" />
            </div>
            <div className="absolute -bottom-6 right-6 hidden sm:block rounded-xl border bg-background/80 p-4 shadow">
              <div className="text-xs text-muted-foreground">Focus & hazard response</div>
              <div className="mt-1 text-sm font-semibold">AI-monitored in real time</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="container py-16 md:py-24">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold sm:text-4xl">Everything learners need</h2>
          <p className="mt-3 text-muted-foreground">From theory to vision to simulation — synced into a single learner profile for instructors and institutions.</p>
        </div>
        <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Feature icon={GraduationCap} title="Learn K53 Theory" desc="Interactive lessons, quizzes, and practice tests with progress tracking." />
          <Feature icon={Gauge} title="DriveIQ Pilot (Simulator)" desc="Realistic driving scenarios: traffic rules, hazard perception, collision avoidance." />
          <Feature icon={Eye} title="DriveIQ Vision (AI Eye Test)" desc="AI-powered vision screening with prescription guidance and compliance logging." />
          <Feature icon={ShieldCheck} title="Verified Optometry" desc="Optometrist verification and spectacle delivery integrated via partners." />
          <Feature icon={Users} title="DriveIQ Connect" desc="Institution portal for TVETs, NSFAS and instructors with analytics and reports." />
          <Feature icon={Smartphone} title="DriveIQ Go (Mobile)" desc="Full mobile access: theory, tracking, notifications and reminders." />
        </div>
      </section>
        ...
        <div className="container py-16 grid gap-8 lg:grid-cols-2 lg:items-center">
          ...
          <div className="order-1 lg:order-2">
            <div className="aspect-[16/10] w-full overflow-hidden rounded-2xl border bg-gradient-to-br from-accent/15 to-primary/15">
              <img src="/placeholder.svg" alt="AI Vision" className="h-full w-full object-cover opacity-90" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="grid gap-8 lg:grid-cols-5 lg:items-center">
          <div className="lg:col-span-3">
            ...
            <ul className="mt-4 text-muted-foreground space-y-2 text-sm">
              ...
              <li>Learners cover exam and transport costs at local testing centres</li>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="md:col-span-2">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                <div className="rounded-xl border bg-card/60 p-5">
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">Hazard anticipation, collision avoidance and safe following distances.</p>
                </div>
                <div className="rounded-xl border bg-card/60 p-5">
                  <div className="text-sm font-semibold">Job Readiness</div>
                  <p className="mt-1 text-sm text-muted-foreground">Communication, teamwork, and workplace professionalism for transport roles.</p>
                </div>
              </div>
            </div>
            <div className="md:col-span-1">
              <div className="rounded-2xl border bg-gradient-to-br from-primary/10 to-accent/10 p-6">
                ...
                <div className="mt-2 text-lg font-semibold">Simulator scenario previews</div>
      ...
      <section id="signup" className="container py-16 md:py-24">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-muted-foreground">Join the Early Bird list, secure your spot, and receive your unique referral link to share.</p>
        </div>
